...
line3 = warping.SimpleTorqueLoad(30, LoadMagnitude = -50.1).GetAllWholeBeam().twist_along_beam()
...
plt.savefig(folder_name+r"\graph_2_4.png")
plt.savefig(folder_name+r"\graph_2_4.pgf")
