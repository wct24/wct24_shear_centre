...
ax[0].plot(line1.index[1:], line1["above"].values[1:], label =  "Distorsion between load and free-end", linewidth=2)
ax[0].plot(line1.index[1:], line1["bellow"].values[1:], label = "Distorsion between load and BC", linewidth=2)
...
plt.savefig(folder_name+r"\graph_distortion.png")
