...
line1 = warping.SimpleTorqueLoad(0, LoadMagnitude =  -50).GetAllWholeBeam().z_rotation_along_beam()
line2 = warping.SimpleTorqueLoad(15, LoadMagnitude = -50).GetAllWholeBeam().z_rotation_along_beam()
line3 = warping.SimpleTorqueLoad(30, LoadMagnitude = -50).GetAllWholeBeam().z_rotation_along_beam()
line4 = warping.SimpleTorqueLoad(45, LoadMagnitude = -50).GetAllWholeBeam().z_rotation_along_beam()
...
line1 = warping.SimpleTorqueLoad(0, LoadMagnitude = -50).GetAllWholeBeam().warping_magnitude_along_beam()
line2 = warping.SimpleTorqueLoad(15, LoadMagnitude = -50).GetAllWholeBeam().warping_magnitude_along_beam()
line3 = warping.SimpleTorqueLoad(30, LoadMagnitude = -50).GetAllWholeBeam().warping_magnitude_along_beam()
line4 = warping.SimpleTorqueLoad(45, LoadMagnitude = -50).GetAllWholeBeam().warping_magnitude_along_beam()
...
ax[1].set_ylabel(r'Warping Magnitude / $m$')
ax[1].grid()
