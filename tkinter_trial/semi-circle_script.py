...
def main():
    ...
    # g, v, d, c = s.geometry, s.vertices, s.dimensions, s.constraints
    # s.setPrimaryObject(option=STANDALONE)
    # s.ArcByCenterEnds(center=(0.0, 0.0), point1=(-0.39, 0.001), point2=(-0.39, -0.001),
    #     direction=CLOCKWISE)
    # s.ArcByCenterEnds(center=(0.0, 0.0), point1=(-0.41, 0.001), point2=(-0.41, -0.001),
    #     direction=CLOCKWISE)
    # s.Line(point1=(-0.39, 0.001), point2=(-0.41, 0.001))
    # # s.VerticalConstraint(entity=g[4], addUndoState=False)
    # # s.PerpendicularConstraint(entity1=g[2], entity2=g[4], addUndoState=False)
    # s.Line(point1=(-0.39, -0.001), point2=(-0.41, -0.001))
    # # s.VerticalConstraint(entity=g[5], addUndoState=False)
    ...
    loading_nodes, number_of_loading_nodes = get_nodes(5.0,n1)
    ...
    a.ReferencePoint(point=(0.50436079, 0.0, 5.0))
    ...
    session.writeFieldReport(fileName='E:/temp/SC/displacement.csv', append=OFF,
