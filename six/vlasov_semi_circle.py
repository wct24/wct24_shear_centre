...
class vlasov:
    ...
    def plot_w_P(self):
        ...
        ax.set_xlim(left=x_offset *0.97, right=0.255)
        ax.set_ylim(top=-y_offset*0.97)

        ax.scatter(0, 0, z_offset, s=70,c= "green", marker='$A$')
        ax.scatter(pole[0], pole[1], z_offset, s=70, c= "indigo", marker='$P$')
    ...
    def plot_w_A(self):
        ...
        ax.plot(u_array, v_array, c='grey')
        # ax.scatter(pole[0], pole[1], 0, c= "grey")
        # perpendicular_vector_array = np.zeros([len(u_array),2])
        # print(perpendicular_vector_array)
        # for i in range(len(u_array)) :
        #     if i == 0:
        ...
        ax.scatter(pole[0], pole[1], z_offset, c= "green", s=70, marker='$A$')
        fig.tight_layout()
...
vlasov(semi_circle(0.40)).plot_w_A()
plt.savefig("D:\\report\\figs\\introduction\\pcp1.png", bbox_inches='tight')
plt.savefig("D:\\report\\figs\\introduction\\pcp1.pgf", bbox_inches='tight')
...
plt.savefig("D:\\report\\figs\\introduction\\pcp.png", bbox_inches='tight')
plt.savefig("D:\\report\\figs\\introduction\\pcp.pgf",  bbox_inches='tight')
