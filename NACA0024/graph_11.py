...
line1 = warping.SimpleTorqueLoad(0, LoadMagnitude =  -50).GetAllWholeBeam().twist_along_beam()
line2 = warping.SimpleTorqueLoad(15, LoadMagnitude = -50).GetAllWholeBeam().twist_along_beam()
line3 = warping.SimpleTorqueLoad(30, LoadMagnitude = -50).GetAllWholeBeam().twist_along_beam()
line4 = warping.SimpleTorqueLoad(45, LoadMagnitude = -50).GetAllWholeBeam().twist_along_beam()
...
line1 = warping.SimpleTorqueLoad(0, LoadMagnitude = -50).GetAllWholeBeam().gamma_along_beam()
line2 = warping.SimpleTorqueLoad(15, LoadMagnitude = -50).GetAllWholeBeam().gamma_along_beam()
line3 = warping.SimpleTorqueLoad(30, LoadMagnitude = -50).GetAllWholeBeam().gamma_along_beam()
line4 = warping.SimpleTorqueLoad(45, LoadMagnitude = -50).GetAllWholeBeam().gamma_along_beam()
...
plt.savefig(folder_name+r"\graph_2_5.png")
plt.savefig(folder_name+r"\graph_2_5.pgf")
