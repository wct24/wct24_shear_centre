...
line1 = warping.SimpleTorqueLoad(0, LoadMagnitude = -1).GetAllWholeBeam().twist_along_beam()
line2 = warping.SimpleTorqueLoad(15, LoadMagnitude = -1).GetAllWholeBeam().twist_along_beam()
line3 = warping.SimpleTorqueLoad(30, LoadMagnitude = -1).GetAllWholeBeam().twist_along_beam()
line4 = warping.SimpleTorqueLoad(45, LoadMagnitude = -1).GetAllWholeBeam().twist_along_beam()
...
ax[0].set_ylabel(r'$\frac{d\theta_{z}}{dz}$ / $radm^{-1}$ ')
ax[0].set_xlabel(r'$Z / m$ ')
ax[0].grid()



line1 = warping.SimpleTorqueLoad(0, LoadMagnitude = -1).GetAllWholeBeam().gamma_along_beam()
line2 = warping.SimpleTorqueLoad(15, LoadMagnitude = -1).GetAllWholeBeam().gamma_along_beam()
line3 = warping.SimpleTorqueLoad(30, LoadMagnitude = -1).GetAllWholeBeam().gamma_along_beam()
line4 = warping.SimpleTorqueLoad(45, LoadMagnitude = -1).GetAllWholeBeam().gamma_along_beam()
...
ax[1].set_ylim(bottom=7.5*10**-6)
ax[1].set_xlim(0,3.05)

# ax[1].xaxis.tick_bottom()
ax[1].set_xlabel(r'$Z / m$ ', )
ax[1].set_ylabel(r'$\Gamma$ / $m^6$')
ax[1].grid()
...
plt.savefig(folder_name+r"\graph_2_10.png")
plt.savefig(folder_name+r"\graph_2_10.pgf")
