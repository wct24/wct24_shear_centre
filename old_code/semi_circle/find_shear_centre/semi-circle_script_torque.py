...
def main():
    ...
    a.ReferencePoint(point=(sc-1.0, 0.0, loading_z))
    r1 = a.referencePoints.values()[0]

    a.ReferencePoint(point=(sc+1.0, 0.0, loading_z))
    r2 = a.referencePoints.values()[0]
    ...
    # region=a.sets['Wire-Set-loading_1']
    ...
    for i in range(0,number_of_loading_nodes):
        wire = a.WirePolyLine(points=((r2, loading_nodes[i]), ), mergeType=IMPRINT, meshable=OFF)
    e1 = a.edges
    a.Set(edges=e1, name='Wire-Set-loading')
    ...
    refPoints1=(r1, )
    region = a.Set(referencePoints=refPoints1, name='loading_1')
    mdb.models['Model-1'].ConcentratedForce(name='Load-1',
        createStepName='loading', region=region, cf2=1000.0,
        distributionType=UNIFORM, field='', localCsys=None)

    refPoints2=(r2, )
    region = a.Set(referencePoints=refPoints2, name='loading_2')
